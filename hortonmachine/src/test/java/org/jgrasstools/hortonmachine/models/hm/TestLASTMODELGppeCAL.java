 ...
 */
public class TestLASTMODELGppeCAL extends HMTestCase {
	public void testShalstab() throws Exception {
		...
		shalstab.inDem = dem;
		shalstab.pTrasmissivity = 82.0;
		shalstab.pCohesion = 597.0;
		shalstab.pSoilPorosity = 0.8;
		shalstab.pTgphi = 0.6;
		shalstab.pQ = 195.0;
		shalstab.pDegreeOfSat = 0.76;
		shalstab.pMode = 0;
		shalstab.process();
