 ...
 */
public class TestShalstabGppeVAL extends HMTestCase {
	public void testShalstab() throws Exception {

		String pathToSlope = "/Users/giuseppeformetta/Desktop/UNICAL/MM2/m/cell/new_A3_slope_VAL";
		...
		String pathToTCA = "/Users/giuseppeformetta/Desktop/UNICAL/MM2/m/cell/new_A3_tca_VAL";
		...
		String pathToSoilDepthMap = "/Users/giuseppeformetta/Desktop/UNICAL/MM2/m/cell/SpessoreDiSuolo_VAL";
		reader = new OmsRasterReader();
...
//		PrintWriter errestat = new PrintWriter(Rstatfile);
		...
		//for (int i = 0; i < nsample; i++) {
			...
			shalstab.pTrasmissivity =5.096;
			shalstab.pCohesion = 60.0;
			shalstab.pRho =  1.61;
			shalstab.pTgphi =  0.46;//0.46;
			shalstab.pQ = 174.0;
			shalstab.pm = pm;
			...
			writer.file = "/Users/giuseppeformetta/Desktop/UNICAL/MM2/m/cell/Classi2_VAL";
			writer.process();

			OmsRasterReader reader2 = new OmsRasterReader();
			reader2.file = "/Users/giuseppeformetta/Desktop/UNICAL/MM2/m/cell/MeasuredForRoc_Val";
			...
			writer.inRaster = classiCoverage;
			writer.file = "/Users/giuseppeformetta/Desktop/UNICAL/MM2/m/cell/ClassiROC_Val";
			writer.process();
