 ...
 */
public class TestLASTMODEL_PAR_CONST_FEB2014_VAL extends HMTestCase {
	public void testShalstab() throws Exception {
		...
		shalstab.pTrasmissivity = 46.54;
		shalstab.pCohesion = 2614.0;
		shalstab.pSoilPorosity = 0.6;
		shalstab.pTgphi = 0.57;
		shalstab.pQ = 53.0;
		shalstab.pDegreeOfSat = 0.17;
		shalstab.pGs = 2.65;
		shalstab.pSdepth = 1.25;
		shalstab.process();

		classiCoverage = shalstab.outShalstab;
		writer = new OmsRasterWriter();
		writer.inRaster = classiCoverage;
		writer.file = "/Users/giuseppeformetta/Desktop/UNICAL/MM2/m/cell/Classi_FS_M2_VAL";
		writer.process();
		...
		writer = new OmsRasterWriter();
		writer.inRaster = classiCoverage;
		writer.file = "/Users/giuseppeformetta/Desktop/UNICAL/MM2/m/cell/ClassiROC_M2_VAL";
		writer.process();
