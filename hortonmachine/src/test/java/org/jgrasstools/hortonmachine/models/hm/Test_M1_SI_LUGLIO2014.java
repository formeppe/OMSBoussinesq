 ...
 */
public class Test_M1_SI_LUGLIO2014 extends HMTestCase {
...
//		 String pPath =
//		 "/Users/giuseppeformetta/Desktop/Sensitivity/M1_SI_Fi";
//		 double par[] = UNIFORM(0.2, 0.7, nsample);

		// String pPath = "/Users/giuseppeformetta/Desktop/Sensitivity/M1_SI_Q";
		// double par[] = UNIFORM(10, 200, nsample);

		 String pPath =
		 "/Users/giuseppeformetta/Desktop/Sensitivity/M1_SI_SD";
		 double par[] = UNIFORM(0.8, 5.0, nsample);
		
//		String pPath = "/Users/giuseppeformetta/Desktop/Sensitivity/M1_SI_T";
//		double par[] = UNIFORM(10, 150.0, nsample);
		...
		for (int i = 0; i < par.length; i++) {
			...
			shalstab.pSdepth =  par[i];//1.3614952070863646 ;
			shalstab.pTrasmissivity =147.6907043013507;
			shalstab.pCohesion = 0;
			shalstab.pRho = 2.784990133579009;
			shalstab.pTgphi =  0.4128880395148833;
			shalstab.pQ = 52.69162581071608;
