 ...
 */
public class Test_M2_SI_LUGLIO2014 extends HMTestCase {
	public void testShalstab() throws Exception {
		...
		int nsample = 200;
//		 String pPath =
//		 "/Users/giuseppeformetta/Desktop/Sensitivity/M2_SI_Fi";
//		 double par[] = UNIFORM(0.2, 0.7, nsample);

//		 String pPath =
//		 "/Users/giuseppeformetta/Desktop/Sensitivity/M2_SI_Q";
//		 double par[] = UNIFORM(10, 200, nsample);
		//
//		 String pPath =
//		 "/Users/giuseppeformetta/Desktop/Sensitivity/M2_SI_SD";
//		 double par[] = UNIFORM(0.8, 5.0, nsample);

//		 String pPath =
//		 "/Users/giuseppeformetta/Desktop/Sensitivity/M2_SI_T";
//		 double par[] = UNIFORM(10, 150.0, nsample);
		//
		String pPath = "/Users/giuseppeformetta/Desktop/Sensitivity/M2_SI_C";
		...
		shalstab.inDem = dem;
		shalstab.pTrasmissivity =	84.53873230700415  ;
		shalstab.pCohesion = par[i];//30013.239612590653  ;
		shalstab.pSoilPorosity =  0.5   ;
		shalstab.pTgphi = 0.45701011899889044  ;
		shalstab.pQ =  294.7001560302787  ;
		shalstab.pDegreeOfSat = 0.5 ;
		shalstab.pSdepth =  2.765158099245438 ;
		shalstab.pGs =  2.743699605901794;
