 ...
 */
public class Test_M3_TSS_LUGLIO2014 extends HMTestCase {
...
//		String pPath = "/Users/giuseppeformetta/Desktop/Sensitivity/M3_TSS_Fi";
//		double par[] = UNIFORM(0.2, 0.7, nsample);

//		 String pPath =
//		 "/Users/giuseppeformetta/Desktop/Sensitivity/M3_TSS_Q";
//		 double par[] = UNIFORM(10, 200, nsample);

//		 String pPath =
//		 "/Users/giuseppeformetta/Desktop/Sensitivity/M3_TSS_SD";
//		 double par[] = UNIFORM(0.8, 5.0, nsample);

//		 String pPath =
//		 "/Users/giuseppeformetta/Desktop/Sensitivity/M3_TSS_T";
//		 double par[] = UNIFORM(10, 150.0, nsample);

//		 String pPath =
//		 "/Users/giuseppeformetta/Desktop/Sensitivity/M3_TSS_C";
//		 double par[] = UNIFORM(0, 50000.0, nsample);

		 String pPath =
		 "/Users/giuseppeformetta/Desktop/Sensitivity/M3_TSS_D";
		...
		for (int i = 0; i < par.length; i++) {
			...
			shalstab.inDem = dem;
			shalstab.pTrasmissivity = 47.03416888415225;
			shalstab.pCohesion = 28505.851355126804;
			shalstab.pSoilPorosity = 0.5;
			shalstab.pTgphi =  0.52685960987795;
			shalstab.pQ = 258.81814461724485;
			shalstab.pDegreeOfSat = 0.5;
			shalstab.pSdepth = 2.2286267603691003;
			shalstab.pDuration =par[i];// 1.2426007483698638;
			shalstab.pMode = 1;
			shalstab.pGs = 2.0822581313164807;
			...
			errestat.println(par[i] + "," + ab.outTrueSkillStatistic);
