 ...
 */
public class Test_M3_ACC_LUGLIO2014 extends HMTestCase {
...
//		String pPath = "/Users/giuseppeformetta/Desktop/Sensitivity/M3_ACC_Fi";
//		double par[] = UNIFORM(0.2, 0.7, nsample);

//		 String pPath =
//		 "/Users/giuseppeformetta/Desktop/Sensitivity/M3_ACC_Q";
//		 double par[] = UNIFORM(10, 200, nsample);

//		 String pPath =
//		 "/Users/giuseppeformetta/Desktop/Sensitivity/M3_ACC_SD";
//		 double par[] = UNIFORM(0.8, 5.0, nsample);

//		 String pPath =
//		 "/Users/giuseppeformetta/Desktop/Sensitivity/M3_ACC_T";
//		 double par[] = UNIFORM(10, 150.0, nsample);

//		 String pPath =
//		 "/Users/giuseppeformetta/Desktop/Sensitivity/M3_ACC_C";
//		 double par[] = UNIFORM(0, 50000.0, nsample);
		
		 String pPath =
		 "/Users/giuseppeformetta/Desktop/Sensitivity/M3_ACC_D";
		...
		for (int i = 0; i < par.length; i++) {
			...
			shalstab.pTrasmissivity =48.71165886801666;
			shalstab.pCohesion =  37086.01128994535;
			shalstab.pSoilPorosity = 0.5;
			shalstab.pTgphi = 0.7948622094936914;
			shalstab.pQ = 193.0192992074639;
			shalstab.pDegreeOfSat = 0.6938031096630479;
			shalstab.pSdepth = 1.0542572506171384;
			shalstab.pDuration = par[i];//1.9766700367803276;
			shalstab.pMode = 1;
			shalstab.pGs = 2.4407087040187596;
