 ...
 */
public class TestShalstabGppeDISTRI_CAL_LUGLIO2014 extends HMTestCase {
	public void testShalstab() throws Exception {
		...
		s.doP1 = true;
		s.p1 = 3.687158048479941;
		s.p2 = 3.952446225846152;
		...
		reader33.file = "/Users/giuseppeformetta/Desktop/UNICAL/MM2/m/cell/NewA3TESS_VAL";
		...
		range.pClasses = 0.5320439838181827 + "," + 0.5320439838181827 * 0.85
				+ "," + 0.5320439838181827 * 0.7;
		range.process();
		...
		shalstab.pTrasmissivity = 11.715388598573062;
		shalstab.pCohesion = 0;
		shalstab.pRho = 1.8848340718562866;
		shalstab.inTgphi = frictionAngle;
		shalstab.pQ = 580.9133505759357;
		shalstab.pm = pm;
		...
		writer.inRaster = classiCoverage;
		writer.file = "/Users/giuseppeformetta/Desktop/UNICAL/MM2/m/cell/Classi_Val_Shalstab_distr";
		writer.process();
		...
		ROC ab = new ROC();
		ab.pPath = "/Users/giuseppeformetta/Desktop/UNICAL/SHALSTAB_SENSITIVITY/RisultatiLuglio2014/shalstab_distr_Val";
		...
		writer = new OmsRasterWriter();
		writer.inRaster = classiCoverage;
		writer.file = "/Users/giuseppeformetta/Desktop/UNICAL/MM2/m/cell/Classi_Roc_Val_Shalstab_distr";
		writer.process();
