 ...
 */
public class Test_M1_TSS_LUGLIO2014 extends HMTestCase {
	public void testShalstab() throws Exception {
		...
		String pPath = "/Users/giuseppeformetta/Desktop/Sensitivity/M1_TSS_Fi";
		...
		for (int i = 0; i < par.length; i++) {
			...
			shalstab.pSdepth = 1.4374730714022423;
			shalstab.pTrasmissivity = 142.67559165478016;
			shalstab.pCohesion = 0;
			shalstab.pRho = 2.7685181705504194;
			shalstab.pTgphi = par[i];//0.4130118341599249;
			shalstab.pQ = 71.36333075801875;
			...
			// writer.inRaster = classiCoverage;
			// writer.file =
			// "/Users/giuseppeformetta/Desktop/UNICAL/SHALSTAB_SENSITIVITY/LastSimulations/Loc_32633_cal/Mapset"
