 ...
 */
public class Test_M3_BS_LUGLIO2014 extends HMTestCase {
	public void testShalstab() throws Exception {
		...
		shalstab.inDem = dem;
		shalstab.pTrasmissivity = 92.56347214386886;
		shalstab.pCohesion = 28027.30911548437;
		shalstab.pSoilPorosity = 0.6896818681513828;
		shalstab.pTgphi = 0.4951272104198265;
		shalstab.pQ = 196.80837106381372;
		shalstab.pDegreeOfSat = 0.1082082528706747;
		shalstab.pSdepth = 1.3670468604918664;
		shalstab.pDuration = 1.7606985651324167;
		shalstab.pMode = 1;
		shalstab.pGs = 2.65;
