 ...
 */
public class Test_M1_AI_LUGLIO2014 extends HMTestCase {
...
//		 String pPath =
//		 "/Users/giuseppeformetta/Desktop/Sensitivity/M1_AI_Fi";
//		 double par[] = UNIFORM(0.2, 0.7, nsample);
//
//		 String pPath = "/Users/giuseppeformetta/Desktop/Sensitivity/M1_AI_Q";
//		 double par[] = UNIFORM(10, 200, nsample);
//
		String pPath = "/Users/giuseppeformetta/Desktop/Sensitivity/M1_AI_SD";
		double par[] = UNIFORM(0.8, 5.0, nsample);

//		 String pPath = "/Users/giuseppeformetta/Desktop/Sensitivity/M1_AI_T";
//		 double par[] = UNIFORM(10, 150.0, nsample);
		...
		for (int i = 0; i < par.length; i++) {
			...
			shalstab.pSdepth =par[i];// 1.3212580366264344;
			shalstab.pTrasmissivity =  140.23682771901235;
			shalstab.pCohesion = 0;
			shalstab.pRho = 2.6128324251191253;
			shalstab.pTgphi = 0.4485931586302687;
			shalstab.pQ = 85.38168531928372;
