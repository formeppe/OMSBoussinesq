 ...
 */
public class Test_DoGridMesh extends HMTestCase {
	public void testShalstab() throws Exception {
		...
		DoGridMesh g=new DoGridMesh();
		g.inSlope=slopeCoverage;
		g.process();
		
		OmsRasterWriter writer = new OmsRasterWriter();
		writer.inRaster = g.outShalstab;
		writer.file = "/Users/giuseppeformetta/Desktop/testMesh/pitLWNUMBERED.asc";
		writer.process();
