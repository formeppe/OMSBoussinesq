 ...
 */
public class Test_M1_DISTR_ESI_LUGLIO2014 extends HMTestCase {
	public void testShalstab() throws Exception {
		...
		s.doP1 = true;
		s.p1 = 2.4005143012427697;
		s.p2 = 1.6981895079909146;
		...
		range.pClasses = 0.5984222800784578 + "," + 0.5984222800784578 * 0.85
				+ "," + 0.5984222800784578 * 0.7;
		range.process();
		...
		shalstab.pTrasmissivity = 9.349664597294554;
		shalstab.pCohesion = 0;
		shalstab.pRho = 2.2677019449500158;
		shalstab.inTgphi = frictionAngle;
		shalstab.pQ = 562.5219049823812;
		shalstab.pm = pm;
