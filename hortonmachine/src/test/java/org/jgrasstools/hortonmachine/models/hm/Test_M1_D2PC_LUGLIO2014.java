 ...
 */
public class Test_M1_D2PC_LUGLIO2014 extends HMTestCase {
...
//		 String pPath =
//		 "/Users/giuseppeformetta/Desktop/Sensitivity/M1_D2PC_Fi";
//		 double par[] = UNIFORM(0.2, 0.7, nsample);

		 String pPath =
		 "/Users/giuseppeformetta/Desktop/Sensitivity/M1_D2PC_Q";
		 double par[] = UNIFORM(10, 200, nsample);
		//
//		 String pPath =
//		 "/Users/giuseppeformetta/Desktop/Sensitivity/M1_D2PC_SD";
//		 double par[] = UNIFORM(0.8, 5.0, nsample);

//		String pPath = "/Users/giuseppeformetta/Desktop/Sensitivity/M1_D2PC_T";
//		double par[] = UNIFORM(10, 150.0, nsample);
		...
		for (int i = 0; i < par.length; i++) {
			...
			shalstab.pSdepth = 2.7999465083343607;
			shalstab.pTrasmissivity =  137.0966556184369 ;
			shalstab.pCohesion = 0;
			shalstab.pRho = 2.707959570694469;
			shalstab.pTgphi = 0.4271464153510481;
			shalstab.pQ = par[i];//50.00492747628985;
