 ...
 */
public class Test_M3_HSS_LUGLIO2014 extends HMTestCase {
...
//		String pPath = "/Users/giuseppeformetta/Desktop/Sensitivity/M3_HSS_Fi";
//		double par[] = UNIFORM(0.2, 0.7, nsample);

//		 String pPath =
//		 "/Users/giuseppeformetta/Desktop/Sensitivity/M3_HSS_Q";
//		 double par[] = UNIFORM(10, 200, nsample);

//		 String pPath =
//		 "/Users/giuseppeformetta/Desktop/Sensitivity/M3_HSS_SD";
//		 double par[] = UNIFORM(0.8, 5.0, nsample);

//		 String pPath =
//		 "/Users/giuseppeformetta/Desktop/Sensitivity/M3_HSS_T";
//		 double par[] = UNIFORM(10, 150.0, nsample);

		 String pPath =
		 "/Users/giuseppeformetta/Desktop/Sensitivity/M3_HSS_C";
		 double par[] = UNIFORM(0, 50000.0, nsample);

//		 String pPath =
//		 "/Users/giuseppeformetta/Desktop/Sensitivity/M3_HSS_D";
//		 double par[] = UNIFORM(0, 3.0, nsample);
		...
		for (int i = 0; i < par.length; i++) {
			...
			shalstab.inDem = dem;
			shalstab.pTrasmissivity = 26.54786364008706;
			shalstab.pCohesion =par[i];// 44329.684495201494;
			shalstab.pSoilPorosity = 0.5;
			shalstab.pTgphi =0.7377338444495197;
			shalstab.pQ =  230.08057614318852;
			shalstab.pDegreeOfSat = 0.5;
			shalstab.pSdepth = 1.4220136754314858;
			shalstab.pDuration = 1.7779892172871983;
			shalstab.pMode = 1;
			shalstab.pGs = 2.5681881081430022;
