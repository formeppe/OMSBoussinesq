 ...
 */
public class Test_M1_DISTR_ACC_LUGLIO2014 extends HMTestCase {
	public void testShalstab() throws Exception {
		...
		shalstab.pTrasmissivity = 38.349664597294554;
		shalstab.pCohesion = 0;
		shalstab.pRho = 1.972677019449500158;
		shalstab.inTgphi = frictionAngle;
		shalstab.pQ = 50.5219049823812;
		shalstab.pm = pm;
