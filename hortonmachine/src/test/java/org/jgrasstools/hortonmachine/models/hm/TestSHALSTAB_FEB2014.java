 ...
 */
public class TestSHALSTAB_FEB2014 extends HMTestCase {
	public void testShalstab() throws Exception {
		...
		writer.file = "/Users/giuseppeformetta/Desktop/UNICAL/MM2/m/cell/Classi_FS_M1";
		writer.process();
		...
		writer = new OmsRasterWriter();
		writer.inRaster = classiCoverage;
		writer.file = "/Users/giuseppeformetta/Desktop/UNICAL/MM2/m/cell/ClassiROC_FS_M1";
		writer.process();
