 ...
 */
public class TestComputeFSGppeCAL extends HMTestCase {
...
//		PrintWriter errestat = new PrintWriter(Rstatfile);
		...
		//for (int i = 0; i < nsample; i++) {
			...
			shalstab.pThresholdFS=1.1;
			shalstab.pTrasmissivity =10.183164574555931 ;
			shalstab.pCohesion =  75.4882148347961;
			shalstab.pRho =    1.6952745365050945;
			shalstab.pTgphi =  0.3954484275197825 ;//0.46;
			shalstab.pQ =  191.9506397533307 ;
			shalstab.pm = pm;
			...
			writer.file = "/Users/giuseppeformetta/Desktop/UNICAL/MM2/m/cell/Classi2_Cal";
			writer.process();
