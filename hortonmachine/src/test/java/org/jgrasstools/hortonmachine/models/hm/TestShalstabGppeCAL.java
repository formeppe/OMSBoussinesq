 ...
 */
public class TestShalstabGppeCAL extends HMTestCase {
	public void testShalstab() throws Exception {
		...
		shalstab.pTrasmissivity = 3.1596642919584963;
		shalstab.pCohesion = 815.752254485915;
		shalstab.pRho = 1.6177897547435263;
		shalstab.pTgphi = 0.3384032596142335;// 0.46;
		shalstab.pQ = 115.04247705630965;
		shalstab.pm = pm;
