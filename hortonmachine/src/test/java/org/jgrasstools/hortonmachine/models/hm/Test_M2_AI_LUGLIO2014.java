 ...
 */
public class Test_M2_AI_LUGLIO2014 extends HMTestCase {
	public void testShalstab() throws Exception {
		...
		int nsample = 200;
		String pPath = "/Users/giuseppeformetta/Desktop/Sensitivity/M2_AI_Fi";
		double par[] = UNIFORM(0.2, 0.7, nsample);

		// String pPath =
		// "/Users/giuseppeformetta/Desktop/Sensitivity/M2_AI_Q";
		// double par[] = UNIFORM(10, 200, nsample);

		// String pPath =
		// "/Users/giuseppeformetta/Desktop/Sensitivity/M2_AI_SD";
		// double par[] = UNIFORM(0.8, 5.0, nsample);

		// String pPath =
		// "/Users/giuseppeformetta/Desktop/Sensitivity/M2_AI_T";
		// double par[] = UNIFORM(10, 150.0, nsample);
		//
		// String pPath = "/Users/giuseppeformetta/Desktop/Sensitivity/M2_AI_C";
		...
		for (int i = 0; i < par.length; i++) {
			...
			shalstab.inDem = dem;
			shalstab.pTrasmissivity = 65.42641394442931;
			shalstab.pCohesion = 25167.899341163873;
			shalstab.pSoilPorosity = 0.5;
			shalstab.pTgphi = par[i];// 0.5656659747064622;
			shalstab.pQ = 236.13693274288127;
			shalstab.pDegreeOfSat = 0.5;
			shalstab.pSdepth = 2.346892900369445;
			shalstab.pGs = 2.105076267620751;
