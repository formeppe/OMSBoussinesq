 ...
 */
public class TestSHALSTAB_FEB2014_VAL extends HMTestCase {
	public void testShalstab() throws Exception {
		...
		shalstab.pSdepth = 2.13;
		shalstab.pTrasmissivity =6.81;
		shalstab.pCohesion = 0;
		shalstab.pRho = 1.68;
		shalstab.pTgphi =0.55;
		shalstab.pQ = 512;
		shalstab.pm = pm;
		...
		writer.file = "/Users/giuseppeformetta/Desktop/UNICAL/MM2/m/cell/Classi_FS_M1_VAL";
		writer.process();
		...
		writer = new OmsRasterWriter();
		writer.inRaster = classiCoverage;
		writer.file = "/Users/giuseppeformetta/Desktop/UNICAL/MM2/m/cell/ClassiROC_FS_M1_VAL";
		writer.process();
