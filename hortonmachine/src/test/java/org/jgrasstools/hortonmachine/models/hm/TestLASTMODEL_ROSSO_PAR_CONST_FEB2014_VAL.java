 ...
 */
public class TestLASTMODEL_ROSSO_PAR_CONST_FEB2014_VAL extends HMTestCase {
	public void testShalstab() throws Exception {
		...
		String pathToDem = "/Users/giuseppeformetta/Desktop/UNICAL/MM2/m/cell/last_PIT_VAL";
		reader = new OmsRasterReader();
		...
		reader2.file = "/Users/giuseppeformetta/Desktop/UNICAL/MM2/m/cell/OKVAL";
		...
		shalstab.pTrasmissivity = 113.0;
		shalstab.pCohesion = 1907.0;
		shalstab.pSoilPorosity = 0.6;
		shalstab.pTgphi = 0.52;
		shalstab.pQ = 158.0;
		shalstab.pDegreeOfSat = 0.79;
		shalstab.pGs = 2.65;
		shalstab.pSdepth = 1.30;
		...
		writer.file = "/Users/giuseppeformetta/Desktop/UNICAL/MM2/m/cell/Classi_FS_M3_VAL";
		writer.process();
		...
		writer = new OmsRasterWriter();
		writer.inRaster = classiCoverage;
		writer.file = "/Users/giuseppeformetta/Desktop/UNICAL/MM2/m/cell/ClassiROC_FS_M3_VAL";
		writer.process();
