 ...
 */
public class Test_M1_DISTR_TSS_LUGLIO2014 extends HMTestCase {
	public void testShalstab() throws Exception {
		...
		s.doP1 = true;
		s.p1 = 4.45687158048479941;
		s.p2 = 3.20952446225846152;
		...
		shalstab.pTrasmissivity = 5.120216103150284;
		shalstab.pCohesion = 0;
		shalstab.pRho = 1.608848340718562866;
		shalstab.inTgphi = frictionAngle;
		shalstab.pQ = 291.9133505759357;
		shalstab.pm = pm;
