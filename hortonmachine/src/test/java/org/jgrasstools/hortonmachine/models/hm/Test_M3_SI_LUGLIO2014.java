 ...
 */
public class Test_M3_SI_LUGLIO2014 extends HMTestCase {
	public void testShalstab() throws Exception {
		...
		String pPath = "/Users/giuseppeformetta/Desktop/Sensitivity/M3_SI_Fi";
		double par[] = UNIFORM(0.2, 0.7, nsample);

//		 String pPath =
//		 "/Users/giuseppeformetta/Desktop/Sensitivity/M3_SI_Q";
//		 double par[] = UNIFORM(10, 200, nsample);

//		 String pPath =
//		 "/Users/giuseppeformetta/Desktop/Sensitivity/M3_SI_SD";
//		 double par[] = UNIFORM(0.8, 5.0, nsample);

//		 String pPath =
//		 "/Users/giuseppeformetta/Desktop/Sensitivity/M3_SI_T";
//		 double par[] = UNIFORM(10, 150.0, nsample);

//		 String pPath =
//		 "/Users/giuseppeformetta/Desktop/Sensitivity/M3_SI_C";
//		 double par[] = UNIFORM(0, 50000.0, nsample);

//		 String pPath =
//		 "/Users/giuseppeformetta/Desktop/Sensitivity/M3_SI_D";
//		 double par[] = UNIFORM(0, 3.0, nsample);
		...
		shalstab.inDem = dem;
		shalstab.pTrasmissivity =57.28404932562829 ;
		shalstab.pCohesion =  45455.777512803026  ;
		shalstab.pSoilPorosity = 0.5;
		shalstab.pTgphi = par[i];//0.3928541762487455  ;
		shalstab.pQ = 299.8999613309277 ;
		shalstab.pDegreeOfSat = 0.5 ;
		shalstab.pSdepth =2.847570540632921 ;
		shalstab.pDuration = 1.2448283439647894  ;
		shalstab.pMode = 1;
		shalstab.pGs = 2.647544465679444 ;
		...
		writer.process();
		 ...
		 errestat.println(par[i] + "," + ab.outSuccessIndex);
