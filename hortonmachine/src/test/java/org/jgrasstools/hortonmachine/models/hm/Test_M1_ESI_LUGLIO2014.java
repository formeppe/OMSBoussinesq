 ...
 */
public class Test_M1_ESI_LUGLIO2014 extends HMTestCase {
	public void testShalstab() throws Exception {
		...
		// String pPath =
		// "/Users/giuseppeformetta/Desktop/Sensitivity/M1_ESI_Fi";
		// double par[] = UNIFORM(0.2, 0.7, nsample);

		// String pPath =
		// "/Users/giuseppeformetta/Desktop/Sensitivity/M1_ESI_Q";
		// double par[] = UNIFORM(10, 200, nsample);
		//
		String pPath = "/Users/giuseppeformetta/Desktop/Sensitivity/M1_ESI_SD";
		double par[] = UNIFORM(0.8, 5.0, nsample);

		// String pPath =
		// "/Users/giuseppeformetta/Desktop/Sensitivity/M1_ESI_T";
		...
		for (int i = 0; i < par.length; i++) {
			...
			shalstab.pSdepth = par[i];// 2.6189534820131355;
			shalstab.pTrasmissivity = 144.6567037711799;
			shalstab.pCohesion = 0;
			shalstab.pRho = 2.7855887854986863;
			shalstab.pTgphi = 0.5648913638114933;
			shalstab.pQ = 69.18798781275274;
